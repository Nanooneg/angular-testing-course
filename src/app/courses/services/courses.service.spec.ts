...
describe('CoursesService', () => {
  ...
  let service: CoursesService, httpTestingController: HttpTestingController;
  ...
  it('should retrieve a specific course', () => {
  ...
  it('should give an error if save course failes', () => {
